...
public class OOASAController implements Initializable {
   ...
   @FXML
    private void loadmovies(ActionEvent event){
        //new function in movies get genre,get path and getnmae are added
        
   Movie a=new Movie("boss","/pics/images.jpg");
        Movie b=new Movie("iinitywar","/pics/download.jpg");
        Movie c=new Movie("ss","/pics/images.jpg");
        Movie d=new Movie("finitywar","/pics/download.jpg");
        Movie e=new Movie("bss","/pics/images.jpg");
        Movie f=new Movie("initywar","/pics/download.jpg");
        Movie g=new Movie("bos","/pics/images.jpg");
        Movie h=new Movie("infiywar","/pics/download.jpg");
        Movie i=new Movie("bos","/pics/images.jpg");
        Movie j=new Movie("iinitywar","/pics/download.jpg");
        Movie k=new Movie("os","/pics/images.jpg");
        Movie l=new Movie("infiniwar","/pics/download.jpg");
    ...
    private void loadseries(ActionEvent event){
        // new functions getSeasoninfo and get name are added
        //new functions path ,numberofepidsodes and get season name are added to season class
//        ArrayList<TVshow> x = new ArrayList();
//        x=MediaContent.getInitTvshow();
//                     
//          String path=x.get(0).getSeasoninfo(0).getpath();
//        Image ima=new Image(path);
//        imageview1.setImage(ima);
//        String name=x.get(0).getSeason();
//        label1.setText(name);
//        
//        path=x.get(1).getSeasoninfo(0).getpath();
//        Image ima2=new Image(path);
//        imageview2.setImage(ima2);
//        name=x.get(1).getSeason();
//        label2.setText(name);
//        
//        path=x.get(2).getSeasoninfo(0).getpath();
//        Image ima3=new Image(path);
//        imageview3.setImage(ima3);
//        name=x.get(2).getSeason();
//        label3.setText(name);
//        
//        path=x.get(3).getSeasoninfo(0).getpath();
//        Image ima4=new Image(path);
//        imageview4.setImage(ima4);
//        name=x.get(3).getSeason();
//        
//        label4.setText(name);
//        path=x.get(4).getSeasoninfo(0).getpath();
//        Image ima5=new Image(path);
//        imageview5.setImage(ima5);
//        name=x.get(4).getSeason();
//        label5.setText(name);
//        
//        path=x.get(5).getSeasoninfo(0).getpath();
//        Image ima6=new Image(path);
//        imageview6.setImage(ima6);
//        name=x.get(5).getSeason();
//        label6.setText(name);
//        
//        path=x.get(6).getSeasoninfo(0).getpath();
//        Image ima7=new Image(path);
//        imageview7.setImage(ima7);
//        name=x.get(6).getSeason();
//        label7.setText(name);
//        
//        path=x.get(7).getSeasoninfo(0).getpath();
//        Image ima8=new Image(path);
//        imageview8.setImage(ima8);
//        name=x.get(7).getSeason();
//        label8.setText(name);
//        
//        
