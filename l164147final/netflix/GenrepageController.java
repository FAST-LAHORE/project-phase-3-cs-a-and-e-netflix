...
//         if(y.get(i).getSeasoninfo(i).getgenre().equalsIgnoreCase(str.s)){//equalsIgnoreCase(str.s)
//         String path=y.get(i).getSeasoninfo(i).getpath();
//         if(path!=null)
//         {genres.add(path);
//         name.add(y.get(i).getSeasoninfo(i).getName());
//         }
//                                                          }
//         }
         ...
         String s3=name.get(0);
         String s4=name.get(1);
         image1.setImage(im1);
         label1.setText(s1);
