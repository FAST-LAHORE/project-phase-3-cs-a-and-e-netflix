...
public class FXMLDocumentController implements Initializable {
        ...
        if(event.getTarget() == yes){
            ...
            if( TitleTV == null || DaTV == null || GenTV == null || CPTV == null){
                ...
                try{
                    c = DriverManager.getConnection("jdbc:derby://localhost:1527/Netflix", "l164206", "qwertyu");
                    s = c.createStatement();
                    remainingStat = "'"+ TitleTV +  "'" + "," + "'" + DaTV + "'" + "," + "'" + (String)GenTV + "'" + "," + "'" + "," + (String)CPTV + "'" + "," + "'" + ","  + String.valueOf(oneM) + "," + String.valueOf(twoM) + "," + String.valueOf(threeM)+ "," + String.valueOf(fourM) + "," + String.valueOf(fiveM) + ")";
                    System.out.println(sql+remainingStat);
                    int q = s.executeUpdate(sql+remainingStat);
                }
                catch(SQLException sq){
    ...
    @FXML 
    private com.jfoenix.controls.JFXTextField pTVDa;
    @FXML 
